...
recommender_models <- recommenderRegistry$get_field_entries(dataType = "realRatingMatrix")
...
recc_matrix <- sapply(predictions@items, 
                      function(x) {as.interger(colnames(ratings_movies) [x]) })
recc_matrix[,1:4]
