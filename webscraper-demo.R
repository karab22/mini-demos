...
rating_data_html <- html_nodes(webpage, '.ratings=imbd-rating strong')
...
actors_data_html <- html_nodes(webpage, '.listener-item-content .ghost+ a')
...
#library('ggplot2')
qplot(data = movies_df, aes(x = Runtime, y = Gross_Earning_in_Mil)) + 
